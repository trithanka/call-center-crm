...
const GrievanceList = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    status: "",
    district: "",
    entryType: "incoming", // Fixed to incoming for grievances
  });
  ...
  useEffect(() => {
    const fetchGrievances = async () => {
      try {
        ...
        // Combine URL status with filters
  ...
  const clearAllFilters = () => {
    setFilters({
      ...
      status: "",
      district: "",
      entryType: "incoming", // Keep as incoming for grievances
    });
    setSearchInput("");
    setCurrentPage(1);
  };
  ...
  // Handle direct form navigation for grievances
  const handleCreateNew = () => {
    // For grievances, directly open incoming form
    navigate("/grievance/new/incoming");
  };
  ...
  return (
    <div className="">
                ...
                <div className="absolute top-full left-0 mt-1 w-48 max-h-96 overflow-y-auto bg-white border border-gray-300 rounded-md shadow-lg z-10">
                  <div className="py-1">
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-xs hover:bg-gray-100 ${
                        !filters.status ? "bg-blue-50 text-blue-700" : ""
                      }`}
                    >
                      All Status
                    </button>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-white border-b-2 border-gray-200">
                <tr>
                  <th className="px-3 py-3 text-left text-[.6rem] font-bold text-gray-500 uppercase">
                    SL No
                  </th>
                  <th className="px-3 py-3 text-left text-[.6rem] font-bold text-gray-500 uppercase">
                    Ticket ID
                  ...
                  <th className="px-3 py-3 text-left text-[.6rem] font-bold text-gray-500 uppercase"></th>
                </tr>
              </thead>
          ...
          <div className="flex flex-col items-center justify-center py-16 px-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm max-w-md">
                There are no grievances at the moment. <br /> Start by creating a new grievance to get started.
              </p>
            </div>
      ...
      {/* Results Summary - Only show when there are grievances */}
      {grievances.length > 0 && (
